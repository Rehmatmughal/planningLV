...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold mb-0">
            ...
            @if($project_id)
                ...
                <span class="text-primary">
                    {{ $projects->where('id',$project_id)->first()?->project_name }}
                </span>
            @endif
        </h4>
        ...
        <div class="d-flex gap-2">
            ...
            @if($project_id)
            <a href="{{ route('projects.blocks.excel', $project_id) }}"
            class="btn btn-success">
                ⬇ Excel Download
            </a>
            @endif
            ...
            <a href="{{ route('blocks.create', ['project_id' => $project_id ?? '']) }}"
            ...
            <form method="GET">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        ...
                        {{-- <a href="{{ route('projects.blocks.index', $project_id) }}" --}}
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    @endcan
                                    @can('street.view')
                                    <a href="{{ route('blocks.streets.index', $block->id) }}"
