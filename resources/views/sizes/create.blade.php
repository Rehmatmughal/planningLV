...
<div class="container mt-4">
    ...
    @endif --}}
        ...
        <div class="mb-3">
            <label>Size</label>
            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Enter size name">
        </div>

        <div class="mb-3">
            <label>Size Area (Sq.Yd)</label>
            <input type="text" name="size_area" class="form-control @error('size_area') is-invalid @enderror" placeholder="Enter size area in Sq.Yd">
        </div>
